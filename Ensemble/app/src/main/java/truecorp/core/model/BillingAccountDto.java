...
public class BillingAccountDto implements Serializable {
	...
	private List<SubscriberDto> subscriber;

	@JsonProperty("invoiceItem")
	private List<InvoiceItemDto> invoiceItem;

	@JsonProperty("banHierarchyTree")
	private List<BanHierarchyTreeDto> banHierarchyTree;

	@JsonProperty("billingEntity")
	private List<BillingEntityDto> billingEntity;
	...
	private List<AdjustmentsDto> adjustment;
	...
	public void setSubscriber(List<SubscriberDto> subscriber) {
	...
	public void setInvoiceItem(List<InvoiceItemDto> invoiceItem) {
		this.invoiceItem = invoiceItem;
	}

	public List<BanHierarchyTreeDto> getBanHierarchyTree() {
		return banHierarchyTree;
	}

	public void setBanHierarchyTree(List<BanHierarchyTreeDto> banHierarchyTree) {
		this.banHierarchyTree = banHierarchyTree;
	}

	public List<BillingEntityDto> getBillingEntity() {
		return billingEntity;
	}

	public void setBillingEntity(List<BillingEntityDto> billingEntity) {
	...
	//Optional method
	@JsonIgnore
	@JsonProperty(value = "user_ignore6")
	public AddressNameLinkDto getAddressNameObj() {
		return getAddressNameObj(0);
	}
	
	@JsonIgnore
	@JsonProperty(value = "user_ignore5")
	public AddressNameLinkDto getAddressNameObj(int inx) {
		if (addressNameLink == null || addressNameLink.isEmpty()) {
			return new AddressNameLinkDto();
		} else {
			if(inx >= addressNameLink.size()) {
				return new AddressNameLinkDto();
			}
		}
		return addressNameLink.get(inx);
	}
	
	@JsonIgnore
	@JsonProperty(value = "user_ignore4")
	public SubscriberDto getSubscriberObj() {
	...
	@JsonIgnore
	@JsonProperty(value = "user_ignore3")
	public InvoiceItemDto getInvoiceItemObj() {
		return getInvoiceItemObj(0);
	}
	
	@JsonIgnore
	public InvoiceItemDto getInvoiceItemObj(int inx) {
		...
		return invoiceItem.get(inx);
	}
	
	@JsonIgnore
	@JsonProperty(value = "user_ignore2")
	public BanHierarchyTreeDto getBanHierarchyTreeObj() {
		if (banHierarchyTree == null || banHierarchyTree.isEmpty()) {
			return new BanHierarchyTreeDto();
		}
		return banHierarchyTree.get(0);
	}
	
	@JsonIgnore
	@JsonProperty(value = "user_ignore1")
	public BillingEntityDto getBillingEntityObj() {
		if (billingEntity == null || billingEntity.isEmpty()) {
			return new BillingEntityDto();
		}
		return billingEntity.get(0);
	}

	@JsonIgnore
	@JsonProperty(value = "user_ignore7")
	public BillDto getBillObj() {
		return getBillObj(0);
	}
	
	@JsonIgnore
	@JsonProperty(value = "user_ignore8")
	public BillDto getBillObj(int inx) {
	...
	@JsonIgnore
	@JsonProperty(value = "user_ignore9")
	public PaymentDto getPaymentObj() {
		return getPaymentObj(0);
	}
	
	@JsonIgnore
	@JsonProperty(value = "user_ignore10")
	public PaymentDto getPaymentObj(int inx) {
		...
		return payment.get(inx);
	}
	
	@JsonIgnore
	@JsonProperty(value = "user_ignore11")
	public boolean isArBalanceLessZero() {
	...
	public List<AdjustmentsDto> getAdjustment() {
		return adjustment;
	}

	public void setAdjustment(List<AdjustmentsDto> adjustment) {
		this.adjustment = adjustment;
	}

	public List<RefundDto> getRefund() {
		return refund;
	}

	public void setRefund(List<RefundDto> refund) {
		this.refund = refund;
	}
