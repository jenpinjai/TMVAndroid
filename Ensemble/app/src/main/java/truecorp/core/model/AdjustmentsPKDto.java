...
public class AdjustmentsPKDto implements Serializable {
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof AdjustmentsPKDto)) {
			return false;
		}
		AdjustmentsPKDto castOther = (AdjustmentsPKDto)other;
		return 
			(this.ban == castOther.ban)
			&& (this.entSeqNo == castOther.entSeqNo)
